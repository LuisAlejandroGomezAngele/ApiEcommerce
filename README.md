...
```powershell
git clone https://github.com/LuisAlejandroGomezAngele/ApiEcommerce.git
cd ApiEcommerce
```
...
Edita el archivo `ApiEcommerce/appsettings.json` y actualiza la cadena de conexión según tu entorno:

```json
{
  "ConnectionStrings": {
    "ConexionSql": "Server=localhost;Database=ApiEcommerceNET8;User ID=SA;Password=Admin123*;TrustServerCertificate=true;MultipleActiveResultSets=true"
  }
}
```
...
{
  "AppSettings": {
    "SecretKey": "EstaEsUnaClaveMuySecretaParaElApiEcommerce"
  }
}
```
...
📄 `ApiEcommerce/API-Ecommerce.postman_collection.json`

### Importar en Postman

1. Abre Postman
2. Click en **Import**
3. Selecciona el archivo `API-Ecommerce.postman_collection.json`
...
Si tienes alguna pregunta o problema, por favor abre un [issue](https://github.com/LuisAlejandroGomezAngele/ApiEcommerce/issues) en GitHub.
